...
export const GoodsPage = styled.div`
  h2 {
    margin-top: 40px;
  }
  ...
  .notic{
    ...
    &:before{
      ...
      background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='24' height='24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M19.778 4.222A10.928 10.928 0 0012 1C9.062 1 6.3 2.144 4.222 4.222A10.928 10.928 0 001 12c0 2.938 1.144 5.7 3.222 7.778A10.928 10.928 0 0012 23c2.938 0 5.7-1.144 7.778-3.222A10.928 10.928 0 0023 12c0-2.938-1.144-5.7-3.222-7.778zM12 5.34c1.066 0 1.934.867 1.934 1.933A1.936 1.936 0 0112 9.207a1.936 1.936 0 01-1.934-1.934c0-1.066.868-1.933 1.934-1.933zm2.75 12.89H9.164v-1.289h.902v-5.156h-.859v-1.289h4.727v6.445h.816v1.29z' fill='%232E9AFF'/%3E%3Cpath d='M12 5.34c1.066 0 1.934.867 1.934 1.933A1.936 1.936 0 0112 9.207a1.936 1.936 0 01-1.934-1.934c0-1.066.868-1.933 1.934-1.933z' fill='%23fff'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M14.75 18.23H9.164v-1.289h.902v-5.156h-.859v-1.289h4.727v6.445h.816v1.29z' fill='%23fff'/%3E%3C/svg%3E");
    }
